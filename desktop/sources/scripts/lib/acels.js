...
function Acels (client) {
  ...
  this.onKeyDown = (e) => {
    ...
    if (!target || !target.downfn) { return this.pipe && this.pipe.onKeyDown ? this.pipe.onKeyDown(e) : null }
    target.downfn()
    e.preventDefault()
  }
  ...
  this.onKeyUp = (e) => {
    const target = this.get(this.convert(e))
    if (!target || !target.upfn) { return this.pipe && this.pipe.onKeyUp ? this.pipe.onKeyUp(e) : null }
    target.upfn()
    e.preventDefault()
  }
